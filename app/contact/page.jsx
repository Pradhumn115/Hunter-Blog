...
const contact = () => {
  ...
  <div className="relative flex -translate-y-24  flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
    ...
    <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96" onSubmit={handleSubmit}>
      ...
      <button
        className="mt-6 block w-full select-none rounded-lg bg-pink-400 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        type="submit"
      ...
      <p className="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
        ...
        <a
          className="font-semibold text-pink-400 transition-colors hover:text-blue-700"
          href="#"
        >
          Sign In
        </a>
