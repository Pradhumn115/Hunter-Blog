...
const about = () => {
  return (
    <div>
      ...
      <section className="relative pt-16 bg-black my-24 ">
              ...
              <div className="w-full md:w-6/12 px-4">
                <div className="relative flex flex-col mt-4">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl mb-1 font-semibold">Structured Blogging</h6>
                    <p className="mb-4 text-blueGray-500">
                      Making Pages And Deploy In a Structured Manner
                    </p>
                  </div>
                </div>
                <div className="relative flex flex-col min-w-0">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mb-4 text-blueGray-500">
                      We also feature many dynamic components for Designing
                    </p>
                  </div>
                </div>
              </div>
              <div className="w-full md:w-6/12 px-4">
                <div className="relative flex flex-col min-w-0 mt-4">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl mb-1 font-semibold">Pages Unlimited</h6>
                    <p className="mb-4 text-blueGray-500">
                      This extension also comes with 3 sample pages. They are
                      fully written so you can start working instantly.
                    </p>
                  </div>
                </div>
                <div className="relative flex flex-col min-w-0 ">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mb-4 text-blueGray-500">
                      Built by our Team For You. You will love how easy
                      is to to work with Hunter Blog.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <footer className="relative bg-black pt-8 pb-6 mt-2">
